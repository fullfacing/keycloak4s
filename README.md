...
* keycloak4s-core:              `"com.fullfacing" %% "keycloak4s-core" % "2.2.4"`
* keycloak4s-admin:             `"com.fullfacing" %% "keycloak4s-admin" % "2.2.4"`
* keycloak4s-admin-monix:       `"com.fullfacing" %% "keycloak4s-admin-monix" % "2.2.4"`
* keycloak4s-auth-akka-http:    `"com.fullfacing" %% "keycloak4s-auth-akka-http" % "2.2.4"`
