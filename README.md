...
[![Maven Central](https://img.shields.io/maven-central/v/com.fullfacing/keycloak4s-core_2.12.svg)](https://search.maven.org/search?q=a:keycloak4s-core_2.13)
...
* keycloak4s-core:              `"com.fullfacing" %% "keycloak4s-core" % "1.2.1"`
* keycloak4s-admin:             `"com.fullfacing" %% "keycloak4s-admin" % "1.2.1"`
* keycloak4s-admin-monix:       `"com.fullfacing" %% "keycloak4s-admin-monix" % "1.2.1"`
* keycloak4s-auth-akka-http:    `"com.fullfacing" %% "keycloak4s-auth-akka-http" % "1.2.1"`
