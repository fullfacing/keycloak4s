...
* keycloak4s-core:              `"com.fullfacing" %% "keycloak4s-core" % "1.2.2"`
* keycloak4s-admin:             `"com.fullfacing" %% "keycloak4s-admin" % "1.2.2"`
* keycloak4s-admin-monix:       `"com.fullfacing" %% "keycloak4s-admin-monix" % "1.2.2"`
* keycloak4s-auth-akka-http:    `"com.fullfacing" %% "keycloak4s-auth-akka-http" % "1.2.2"`
