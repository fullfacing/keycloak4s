package com.fullfacing.keycloak4s.admin.implicits

import scala.annotation.implicitAmbiguous
import scala.reflect.Manifest

/**
 * Used to represent a generic type that cannot be a Nothing, and therefore must be specified. Carries a Manifest of the type.
