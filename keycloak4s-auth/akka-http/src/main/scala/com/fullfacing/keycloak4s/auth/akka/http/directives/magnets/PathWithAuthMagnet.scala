...
object PathWithAuthMagnet {
  ...
  implicit def simplePath(resource: String)(implicit permissions: AuthPayload): PathWithAuthMagnet[Tuple1[AuthRoles]] =
    new PathWithAuthMagnet[Tuple1[AuthRoles]] {
  ...
  implicit def tuplePath1(params: (String, PathMatcher[Tuple1[UUID]]))(implicit permissions: AuthPayload): PathWithAuthMagnet[(AuthRoles, UUID)] =
    new PathWithAuthMagnet[(AuthRoles, UUID)] {
  ...
  implicit def tuplePath2(params: (PathMatcher[Tuple1[UUID]], String))(implicit permissions: AuthPayload): PathWithAuthMagnet[(AuthRoles, UUID)] =
    new PathWithAuthMagnet[(AuthRoles, UUID)] {
      override type Result = Directive[(AuthRoles, UUID)]
