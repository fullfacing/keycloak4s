...
object PathWithAuthMagnet {
  ...
  implicit def simplePath(resource: String)(implicit permissions: AuthPayload): PathWithAuthMagnet[Tuple1[ResourceRoles]] =
  ...
  implicit def tuplePath1(params: (String, PathMatcher[Tuple1[UUID]]))(implicit permissions: AuthPayload): PathWithAuthMagnet[(ResourceRoles, UUID)] =
  ...
  implicit def tuplePath2(params: (PathMatcher[Tuple1[UUID]], String))(implicit permissions: AuthPayload): PathWithAuthMagnet[(ResourceRoles, UUID)] =
    new PathWithAuthMagnet[(ResourceRoles, UUID)] {
      override type Result = Directive[(ResourceRoles, UUID)]
