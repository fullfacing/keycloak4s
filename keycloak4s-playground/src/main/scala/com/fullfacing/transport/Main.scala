...
import com.fullfacing.keycloak4s.admin.monix.client.{KeycloakClient => KeycloakClientM}
...
//      implicit val backend: client3.SttpBackend[Future, AkkaStreams with capabilities.WebSockets] = AkkaHttpBackend()
...
//    }
//
//    implicit val client: KeycloakClient[Task] = genericClient //slot in preferred client
