...
object Main extends TaskApp {
  def run(args: List[String]): Task[ExitCode] = Akka.connect().flatMap { _ =>
    ...
    val adminSecret: String = "6808820a-b662-4480-b832-f2d024eb6e03" //Secret of adminClient.
    ...
    val users = Keycloak.RealmsAdmin[Task, Source[ByteString, Any]]
    ...
    users.fetchAdminEvents(operationTypes = Some(List("UPDATE"))).foreachL {
