...
final case class RealmRepresentation(accessCodeLifespan: Option[Int],
                                     ...
                                     browserSecurityHeaders: Option[Map[String, String]],
                                     bruteForceProtected: Option[Boolean],
                                     clientAuthenticationFlow: Option[String],
                                     clientScopeMappings: Option[Map[String, Any]],
                                     ...
                                     smtpServer: Option[Map[String, Any]],
                                     ...
                                     userFederationProviders: Option[List[UserFederationProvider]],
