...
class Clients[R[+_]: Concurrent, S](implicit keycloakClient: KeycloakClient[R, S]) {
   ...
   * @return
   */
  def createNewInitialAccessToken(realm: String, config: ClientInitialAccessCreate): R[Either[KeycloakError, ClientInitialAccess]] = {
  ...
  /**
    ...
    * @return
    */
  def getInitialAccessTokens(realm: String): R[Either[KeycloakError, Seq[ClientInitialAccess]]] = {
  ...
  /**
    ...
    * @return
    */
  def deleteInitialAccessToken(tokenId: String, realm: String): R[Either[KeycloakError, Unit]] = {
     ...
     * @return
     */
    def createNewClient(realm: String, client: Client): R[Either[KeycloakError, Unit]] = {
     ...
     * @return
     */
    def getRealmClients(realm: String, clientId: Option[String] = None, viewableOnly: Boolean = false): R[Either[KeycloakError, Seq[Client]]] = {
     ...
     * @return
     */
    def getClient(clientId: String, realm: String): R[Either[KeycloakError, Client]] = {
     ...
     * @return
     */
    def updateClient(clientId: String, realm: String, c: Client): R[Either[KeycloakError, Unit]] = {
      val path = Seq(realm, "clients", clientId)
     ...
     * @return
     */
    def deleteClient(clientId: String, realm: String): R[Either[KeycloakError, Unit]] = {
      val path = Seq(realm, "clients", clientId)
     ...
     * @return
     */
    def generateClientSecret(clientId: String, realm: String): R[Either[KeycloakError, Credential]] = {
     ...
     * @return
     */
    def getClientSecret(clientId: String, realm: String): R[Either[KeycloakError, Credential]] = {
      val path = Seq(realm, "clients", clientId, "client-secret")
     ...
     * @return
     */
    def getDefaultClientScopes(clientId: String, realm: String): R[Either[KeycloakError, List[ClientScope]]] = {
     ...
     * @return
     */
    def updateClientScope(clientScopeId: String, clientId: String, realm: String): R[Either[KeycloakError, Unit]] = {
     ...
     * @return
     */
    def deleteClientScope(clientScopeId: String, clientId: String, realm: String): R[Either[KeycloakError, Unit]] = {
      val path = Seq(realm, "clients", clientId, "default-client-scopes", clientScopeId)
      keycloakClient.delete(path)
    }
     ...
     * @return
     */
    def generateAccessTokenExample(clientId: String, realm: String, scope: Option[String] = None, userId: Option[String] = None): R[Either[KeycloakError, AccessToken]] = {
     ...
     * @return
     */
    def getProtocolMappers(clientId: String, realm: String, scope: Option[String] = None): R[Either[KeycloakError, Seq[ClientScopeEvaluateResourceProtocolMapperEvaluation]]] = {
     ...
     * @return
     */
    def getEffectiveScopeMapping(clientId: String, realm: String, roleContainerId: String, scope: Option[String]): R[Either[KeycloakError, Seq[Role]]] = {
      val query = createQuery(("scope", scope))
     ...
     * @return
     */
    def getNonScopeRoles(clientId: String, realm: String, roleContainerId: String, scope: Option[String]): R[Either[KeycloakError, Seq[Role]]] = {
      val query = createQuery(("scope", scope))
     ...
     * @return
     */
    def getClientInstallationProvider(clientId: String, providerId: String, realm: String): R[Either[KeycloakError, Unit]] = {
     ...
     * @return
     */
    def getClientAuthorizationPermissions(clientId: String, realm: String): R[Either[KeycloakError, ManagementPermission]] = {
     ...
     * @return
     */
    def updateClientAuthorizationPermissions(clientId: String, realm: String, permission: ManagementPermission): R[Either[KeycloakError, ManagementPermission]] = {
      val path = Seq(realm, "clients", clientId, "management", "permissions")
     ...
     * @return
     */
    def registerClusterNode(clientId: String, realm: String, node: String): R[Either[KeycloakError, Unit]] = {
     ...
     * @return
     */
    def unregisterClusterNode(clientId: String, realm: String): R[Either[KeycloakError, Unit]] = {
      val path = Seq(realm, "clients", clientId, "nodes")
      keycloakClient.delete(path)
    }
     ...
     * @return
     */
    def getOfflineSessionCount(clientId: String, realm: String): R[Either[KeycloakError, Count]] = {
     ...
     * @return
     */
    def getOfflineSessions(clientId: String, realm: String, first: Option[Int] = None, max: Option[Int] = None): R[Either[KeycloakError, List[UserSession]]] = {
      val query = createQuery(
        ("first", first),
        ("max", max)
      )
     ...
     * @return
     */
    def getOptionalClientScopes(clientId: String, realm: String): R[Either[KeycloakError, List[ClientScope]]] = {
     ...
     * @return
     */
    def updateOptionalClientScope(clientScopeId: String, clientId: String, realm: String): R[Either[KeycloakError, Unit]] = {
     ...
     * @return
     */
    def deleteOptionalClientScope(clientScopeId: String, clientId: String, realm: String): R[Either[KeycloakError, Unit]] = {
      val path = Seq(realm, "clients", clientId, "optional-client-scopes", clientScopeId)
      keycloakClient.delete(path)
    }
     ...
     * @return
     */
    def pushRevocationPolicy(clientId: String, realm: String): R[Either[KeycloakError, GlobalRequestResult]] = {
     ...
     * @return
     */
    def generateRegistrationAccessToken(clientId: String, realm: String): R[Either[KeycloakError, Client]] = {
     ...
     * @return
     */
    def getServiceAccountUser(clientId: String, realm: String): R[Either[KeycloakError, User]] = {
     ...
     * @return
     */
    def getSessionCount(clientId: String, realm: String): R[Either[KeycloakError, Count]] = {
     ...
     * @return
     */
    def testNodesAvailability(clientId: String, realm: String): R[Either[KeycloakError, GlobalRequestResult]] = {
     ...
     * @return
     */
    def getUserSessions(clientId: String, realm: String, first: Option[Int] = None, max: Option[Int] = None): R[Either[KeycloakError, List[UserSession]]] = {
      val query = createQuery(
        ("first", first),
        ("max", max)
      )
     ...
     * @return
     */
    def getClientRegistrationPolicyProviders(realm: String): R[Either[KeycloakError, List[ComponentType]]] = {
     ...
     * @return
     */
    def addRolesToGroup(clientId: String, groupId: String, realm: String, roles: Seq[Role]): R[Either[KeycloakError, Unit]] = {
     ...
     * @return
     */
    def getGroupRoleMappings(clientId: String, groupId: String, realm: String): R[Either[KeycloakError, Seq[Role]]] = {
      val path = Seq(realm, "groups", groupId, "role-mappings", "clients", clientId)
      keycloakClient.get(path)
    }
     ...
     * @return
     */
    def deleteGroupRoles(clientId: String, groupId: String, realm: String, roles: Seq[Role]): R[Either[KeycloakError, Unit]] = {
      val path = Seq(realm, "groups", groupId, "role-mappings", "clients", clientId)
     ...
     * @return
     */
    def getAvailableGroupRoles(clientId: String, groupId: String, realm: String): R[Either[KeycloakError, List[Role]]] = {
     ...
     * @return
     */
    def getEffectiveGroupRoles(clientId: String, groupId: String, realm: String): R[Either[KeycloakError, List[Role]]] = {
     ...
     * @return
     */
    def addRolesToUser(clientId: String, userId: String, realm: String, roles: Seq[Role]): R[Either[KeycloakError, Unit]] = {
     ...
     * @return
     */
    def getUserRoleMappings(clientId: String, userId: String, realm: String): R[Either[KeycloakError, List[Role]]] = {
      val path = Seq(realm, "users", userId, "role-mappings", "clients", clientId)
      keycloakClient.get[List[Role]](path)
    }
     ...
     * @return
     */
    def deleteUserRoles(clientId: String, groupId: String, realm: String, roles: Seq[Role]): R[Either[KeycloakError, Unit]] = {
      val path = Seq(realm, "groups", groupId, "role-mappings", "clients", clientId)
      keycloakClient.delete(path, roles)
    }
     ...
     * @return
     */
    def getAvailableUserRoles(clientId: String, userId: String, realm: String): R[Either[KeycloakError, List[Role]]] = {
     ...
     * @return
     */
    def getEffectiveUserRoles(clientId: String, userId: String, realm: String): R[Either[KeycloakError, List[Role]]] = {
     ...
     * @return
     */
    def getKeyInfo(attribute: String, clientId: String, realm: String): R[Either[KeycloakError, Certificate]] = {
     ...
     * @return
     */
    def getKeystoreFile(attribute: String, clientId: String, realm: String, config: KeyStoreConfig): R[Either[KeycloakError, File]] = {
     ...
     * @return
     */
    def generateNewCertificate(attribute: String, clientId: String, realm: String): R[Either[KeycloakError, Certificate]] = {
     ...
     * @return
     */
    def generateAndDownloadNewCertificate(attribute: String, clientId: String, realm: String, config: KeyStoreConfig): R[Either[KeycloakError, File]] = {
     ...
     * @return
     */
    def uploadCertificateWithPrivateKey(attribute: String, clientId: String, realm: String, file: File): R[Either[KeycloakError, Certificate]] = {
     ...
     * @return
     */
    def uploadCertificateWithoutPrivateKey(attribute: String, clientId: String, realm: String, file: File): R[Either[KeycloakError, Certificate]] = {
     ...
     * @return
     */
    def createNewClientScope(realm: String, clientScope: ClientScope): R[Either[KeycloakError, Unit]] = {
     ...
     * @return
     */
    def updateClientScope(scopeId: String, realm: String, clientScope: ClientScope): R[Either[KeycloakError, Unit]] = {
     ...
     * @return
     */
    def deleteClientScope(scopeId: String, realm: String): R[Either[KeycloakError, Unit]] = {
      val path = Seq(realm, "client-scopes", scopeId)
      keycloakClient.delete(path)
    }
     ...
     * @return
     */
    def getRealmClientScopes(realm: String): R[Either[KeycloakError, List[ClientScope]]] = {
      val path = Seq(realm, "client-scopes")
      keycloakClient.get[List[ClientScope]](path)
    }
     ...
     * @return
     */
    def getClientScope(scopeId: String, realm: String): R[Either[KeycloakError, ClientScope]] = {
      val path = Seq(realm, "client-scopes", scopeId)
      keycloakClient.get(path)
    }
}